...
async function start(session) {
    ...
    conn.connect().then(() => {
        ...
        console.log('\n')
        console.log(color('<= ', 'yellow'), color(`Name : ${conn.user.name}`, 'aqua'), color(' =>', 'yellow'))
        console.log(color('<= ', 'yellow'), color(`Nomer : ${conn.user.jid.split('@')[0]}`, 'aqua'), color(' =>', 'yellow'))
        console.log(color('<= ', 'yellow'), color('Library : Baileys', 'aqua'), color(' =>', 'yellow'))
        console.log('\n')
        console.log(color('<=====[CONNECTED]=====>', 'magenta'))

(async () => {
     switch(true) {
         case /^cowok$/i.test(command): {
             ...
             cowokk = await functions.getBuffer(randKey.result)
         ...
         case /^cewek$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             cewekk = await functions.getBuffer(randKey.result)
         ...
         case /^exo$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             xoo = await functions.getBuffer(randKey.result)
         ...
         case /^bts(batues|butues)$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             batues = await functions.getBuffer(randKey.result)
         ...
         case /^blackpink$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             blakpink = await functions.getBuffer(randKey.result)
         ...
         case /^dark(joke|jokes)$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             gelapjok = await functions.getBuffer(randKey.result)
         ...
         case /^cosplay$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             cospla = await functions.getBuffer(randKey.result)
         ...
         case /^waifu$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             waifuu = await functions.getBuffer(randKey.result)
         ...
         case /^(wallpaperprogrammer|wlpprogram|wlpcoding|wlphacker)$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             perr = await functions.getBuffer(randKey.result)
         ...
         case /^asupan$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             asupan = await functions.getBuffer(randKey.result)
         ...
         case /^asupan(uwu|loli)$/i.test(command): {
             ...
             randConn = Math.floor(Math.random() * jsonData.length);
             randKey = jsonData[randConn];
             asupanlol = await functions.getBuffer(randKey.result)
